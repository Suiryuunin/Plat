...
const playerH = 64;
const playerMH = 58;
const player1 = new Dynamic("rect", {x:64,y:res.h/2-64,w:playerW,h:playerH, o: {x:-0.5,y:-1}}, I_PLAYER, new RectCollider());
player1.name = "player";
player1.type = "img";
...
const crouchWall = new Dynamic("rect", {x:256,y:res.h-12-16-5,     w:128,h:512, o: {x:0,y:-1}}, BGCOLOR, new RectCollider());
const crouchWall2 = new Dynamic("rect", {x:1024,y:res.h-12-16-5-16,     w:128,h:128, o: {x:0,y:-1}}, BGCOLOR, new RectCollider());
